    ...
    <div className="min-w-0 space-y-4 sm:space-y-6">
      <div className="mx-auto max-w-6xl min-w-0 space-y-3 px-0 sm:px-1">
        <div className="flex sm:justify-end">
          <Link href="/dashboard/developer/status" className="inline-flex min-h-11 w-full items-center justify-center rounded-lg border border-indigo-700/50 bg-indigo-950/30 px-4 py-2.5 text-center text-sm font-medium text-indigo-200 transition-colors hover:bg-indigo-900/40 sm:w-auto">View submission status & timeline</Link>
        </div>
